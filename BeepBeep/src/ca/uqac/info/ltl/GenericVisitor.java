...
public class GenericVisitor implements OperatorVisitor
{
  ...
  public void visit(OperatorXor o)
  {
    StringBuffer right = m_pieces.pop();
    StringBuffer left = m_pieces.pop();
    StringBuffer out = new StringBuffer("(").append(left).append(") ").append(OperatorXor.SYMBOL).append(" (").append(right).append(")");
    m_pieces.push(out);
  }
  ...
  public void visit(OperatorGreaterThan o)
  {
    StringBuffer right = m_pieces.pop();
    StringBuffer left = m_pieces.pop();
    StringBuffer out = new StringBuffer("").append(left).append(") ").append(OperatorGreaterThan.SYMBOL).append(" (").append(right).append("");
    m_pieces.push(out);
  }
